...
Object.assign(FenceTheFarm.prototype, {
  ...
  compareBuilds(A, B, perimeter, opts) {
    ...
    const GAP = 150, SPAN = 1180, GROUND = 470, DEPTH = 262;
    ...
    this.el['fin-a-lbl'].style.left = Math.round(ax + wA / 2 - 133) + 'px';
    this.el['fin-b-lbl'].style.left = Math.round(bx + wB / 2 - 133) + 'px';
    this.el["fin-a-lbl"].style.top = this.el["fin-b-lbl"].style.top = (GROUND + 12) + "px";
